'''
    This is a testbed's Qt facilitator: used to create window, GUI and handles user-input.

    Copy-paste from: https://github.com/cprogrammer1994/ModernGL/tree/master/examples
'''
